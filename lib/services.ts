...
export const SERVICES: Service[] = [
  {
    ...
    short:
      "Conversational ordering, payment and support over voice â€” for delivery, pickup and high-volume call centres.",
    icon: "mic",
    tags: ["Takeaway ordering", "Payments", "Call deflection"],
    problem: {
      title: "Every unanswered call is revenue walking out the door",
      body: "Front-of-house teams juggle phones mid-service, and after hours callers hit voicemail. Voice Commerce answers on the first ring, takes the order or booking, takes payment, and confirms â€” in natural Australian English, at any hour.",
      points: [
    ...
    features: [
      {
        ...
        body: "Warm, locally-accented speech that regulars feel comfortable talking to â€” no robotic menu trees.",
      },
      {
      ...
      },
      {
        ...
        body: "Orders land straight in your POS or kitchen display â€” no re-keying, no double-handling.",
      },
      {
      ...
      },
      {
        ...
        body: "A lifeline for customers who can't or won't use apps â€” voice remains the most inclusive channel.",
      },
      {
        title: "Live analytics",
        body: "Call volume, containment rate, average order value and peak windows â€” visible from day one.",
      },
    ],
    howItWorks: [
      {
      ...
      {
        title: "Train",
        body: "We tune the assistant to your menu, prices, hours and house phrases â€” approved by you before go-live.",
      },
      {
        title: "Launch",
    ...
    useCases: [
      {
        ...
        body: "Guests book, amend or cancel tables at 10pm on a Sunday â€” and the team walks into a clean booking sheet on Monday.",
      },
      {
        industry: "Retail",
      ...
      },
      {
        ...
        body: "Peak-hour order spikes overflow to voice instead of dropping â€” average order value holds because the AI upsells consistently.",
      },
    ],
    faq: [
      {
        q: "Will customers know they're talking to an AI?",
        a: "We're upfront by design â€” the assistant introduces itself naturally and offers a human hand-off at any point. Most callers simply care that the task gets done fast.",
      },
      {
        q: "Can it really take payments over the phone?",
        a: "Yes. Card payments are processed through your payment gateway with tokenised, PCI-aware handling â€” no card numbers are stored on our platform.",
      },
      {
      ...
      },
      {
        ...
        a: "Most voice commerce deployments go live within 4â€“6 weeks, including menu training, payment setup and a supervised soft launch.",
      },
    ],
  },
  {
    ...
    short:
      "Service bookings, parts enquiries and showroom chats â€” automated across phone, web and SMS.",
    icon: "chat",
    tags: ["Service booking", "Parts lookup", "Web chat"],
    problem: {
      title: "Your service department is losing bookings it never hears about",
      body: "After-hours browsers become tomorrow's competitors' bookings. Chat AI Automotive answers every web chat, SMS and enquiry the moment it arrives â€” quoting, booking and qualifying so your advisors start the day with a full schedule.",
      points: [
    ...
    features: [
      ...
      },
      {
        ...
        body: "Answers 'how much forâ€¦' questions instantly from your parts catalogue and pricing rules.",
      },
      {
      ...
      },
      {
        ...
        body: "Books test drives against real loan-car and staff availability â€” no double-ups.",
      },
    ],
    howItWorks: [
      {
    ...
    useCases: [
      ...
      },
      {
        ...
        body: "Trade and retail parts queries get instant answers from your catalogue â€” and a logged lead when it's a special order.",
      },
      {
    ...
    faq: [
      {
        ...
        a: "Major DMS and workshop scheduling platforms plus custom APIs â€” bookings, customer records and quotes stay in your system of record.",
      },
      {
      ...
      },
      {
        ...
        a: "Yes â€” web chat, SMS and Messenger share one brain, so a conversation can start on one channel and finish on another.",
      },
      {
      ...
      },
      {
        ...
        a: "It takes action â€” it checks real availability, quotes real prices, writes real bookings and follows up, instead of just answering FAQs.",
      },
    ],
  },
  {
    ...
    short:
      "Menu-adaptive AI ordering for quick-service restaurants â€” faster lanes, smoother upsells, lower staff load.",
    icon: "drive",
    tags: ["Menu adaptive", "Upsell", "Throughput"],
    problem: {
      title: "The drive-thru is your busiest, most stressful revenue line",
      body: "Peak-hour lanes back up, headsets get dropped mid-order, and upsells depend on whoever's having the busiest shift. Dynamic DriveThru takes every order, every hour, at full menu accuracy â€” and never has a bad day.",
      points: [
    ...
    features: [
      {
        ...
        body: "Sold-out items, price changes and limited-time offers flow through instantly â€” the AI never sells what you can't make.",
      },
      {
      ...
      },
      {
        ...
        body: "Tuned for lane noise, wind, idling engines and drive-through accents â€” barge-in and all.",
      },
      {
      ...
      },
      {
        ...
        body: "Service time, average basket, upsell rate and peak windows â€” per lane, per hour, per daypart.",
      },
    ],
    howItWorks: [
      {
    ...
    useCases: [
      ...
      },
      {
        ...
        body: "The 1am menu is just as accurate as the 1pm menu â€” and the late-night regulars get the same polite service.",
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: "Yes â€” the speech models are tuned for Australian conditions including lane noise, and accuracy is measured continuously against completed orders.",
      },
      {
      ...
      },
      {
        ...
        a: "Payment stays exactly as it is today â€” cash at the window or card at the reader. The AI handles the ordering, not the tender.",
      },
      {
  ...
  },
  {
    ...
    short:
      "Autonomous agents that handle enquiries end to end â€” and hand off to humans only when it matters.",
    icon: "agent",
    tags: ["Enquiry triage", "Back-office", "Hand-off"],
    problem: {
      title: "Your team drowns in routine while the important work waits",
      body: "Repetitive enquiries, data entry and follow-ups consume the hours that growth needs. AI Agents take the routine end to end â€” safely, within guardrails you define â€” and hand off to humans with full context when judgement is required.",
      points: [
    ...
    features: [
      {
        ...
        body: "Classifies, answers and resolves routine enquiries across email, chat and voice â€” and logs everything.",
      },
      {
      ...
      },
      {
        ...
        body: "Passes the full conversation and state to your team's tools â€” nobody ever asks a customer to repeat themselves.",
      },
      {
      ...
      },
      {
        ...
        body: "Every action, decision and hand-off is logged and searchable â€” accountability by default.",
      },
    ],
    howItWorks: [
      {
      ...
      {
        title: "Expand",
        body: "As trust and metrics grow, we extend its scope one workflow at a time â€” never big-bang.",
      },
    ],
    useCases: [
      {
    ...
    faq: [
      {
        ...
        a: "That is decided by you â€” common first steps are booking, rescheduling, FAQ resolution and updating customer notes, always within defined limits.",
      },
      {
        q: "Is it safe to give an agent access to our systems?",
        a: "We use scoped, least-privilege integrations, action logs and approval workflows â€” the agent can only do what is explicitly allowed.",
      },
      {
        q: "Does it replace our staff?",
        a: "It replaces the repetitive workload, not the people â€” your team gets the judgement calls and the customer moments that matter.",
      },
      {
      ...
      },
      {
        ...
        a: "Most deployments begin with one contained workflow â€” after-hours enquiries or booking confirmations â€” and expand on evidence.",
      },
    ],
  },
  {
    ...
    short:
      "Combine Square's smart operations with Talent Trek's CRM and Voice AI â€” manage POS, appointments, marketing and messaging from one place.",
    icon: "square",
    ...
    features: [
      ...
      { title: "Voice AI Unification", body: "Voice AI connects and powers the entire stack â€” orders, bookings and enquiries handled conversationally." },
    ],
    howItWorks: [
    ...
    useCases: [
      ...
      { industry: "CafÃ©s", title: "Quick service", body: "Fast POS with voice ordering and automated loyalty rewards for high-volume cafÃ©s." },
    ...
    faq: [
      { q: "Do I already need Square?", a: "Yes â€” this service connects and extends your existing Square POS with CRM and Voice AI capabilities." },
  ...
  },
  {
    ...
    problem: {
      ...
      body: "Off-the-shelf CRMs force your workflow into their structure. We build systems the other way around â€” your processes, brand and guest engagement strategies come first.",
    ...
    features: [
      { title: "AI-Powered, Voice-Enabled", body: "Every custom CRM is built ready for voice â€” integrating seamlessly with Talent Trek Voice AI." },
    ...
    faq: [
      { q: "How is this different from off-the-shelf?", a: "Built specifically for your workflows, brand and processes â€” not a generic template." },
      { q: "Can it integrate with my POS?", a: "Yes â€” Square, Clover, Lightspeed and other major POS systems." },
  ...
  },
  {
    ...
    short:
      "Build deeper guest connections, drive repeat visits and streamline service â€” powered by AI and real-time insights built for hospitality.",
    icon: "database",
    ...
    features: [
      ...
      { title: "Safe and Scalable", body: "Enterprise-grade security for single cafÃ©s through to 100+ outlet groups." },
    ...
    useCases: [
      ...
      { industry: "CafÃ©s", title: "Regular recognition", body: "Remembering orders, names and preferences for every regular." },
  ...
  },
  {
    ...
    short:
      "A professional AI receptionist that answers, qualifies and routes calls 24/7 â€” for professional services, healthcare, trades and real estate across Australia.",
    icon: "phone",
    tags: ["Call Answering", "Lead Qualification", "After-Hours"],
    problem: {
      title: "Every missed call is a missed opportunity",
      body: "Professional services, healthcare and trades still rely on humans to answer phones. After hours, during peak times, or when staff are busy â€” calls go unanswered. Our AI receptionist answers on the first ring, qualifies callers and routes them intelligently.",
    ...
    features: [
      { title: "Natural Australian Voice", body: "A warm, professional Australian accent that represents your brand â€” not a robotic menu tree." },
      { title: "24/7 Call Answering", body: "Never miss a call â€” day, night, weekends and public holidays." },
    ...
    howItWorks: [
      ...
      { title: "Go Live", body: "Receptionist answers calls â€” optional supervised period before full autonomy." },
    ...
    faq: [
      { q: "Will callers know it's an AI?", a: "You choose â€” introduce by name and role, or keep transparent as an AI assistant." },
      ...
      { q: "Can it transfer to a human?", a: "Yes â€” complex calls warm-transfer to your team with full context so the caller never repeats themselves." },
    ],
  },
  {
    ...
    short:
      "AI-powered appointment scheduling that lets clients book, reschedule and cancel by voice or chat â€” with smart reminders and calendar sync.",
    icon: "calendar",
    ...
    features: [
      { title: "Voice and Chat Booking", body: "Clients book via phone call or chat â€” whichever they prefer, 24/7." },
    ...
    howItWorks: [
      ...
      { title: "Launch", body: "Clients book by phone or chat â€” with optional staff approval workflows." },
    ...
    faq: [
      { q: "What calendars does it support?", a: "Google Calendar, Microsoft Outlook/365 and Apple Calendar â€” with real-time two-way sync." },
      { q: "Can clients reschedule themselves?", a: "Yes â€” clients receive a link to reschedule or cancel without calling your office." },
  ...
  },
  {
    ...
    short:
      "AI voice and chat assistants that speak Mandarin, Cantonese, Hindi, Vietnamese, Arabic and more â€” built for Australia's diverse communities.",
    icon: "globe",
    tags: ["Multilingual", "Voice", "Chat", "24/7"],
    problem: {
      title: "English-only AI excludes your customers",
      body: "Over 30% of Australians speak a language other than English at home. Your AI assistant should speak their language â€” not force them into English. We build multilingual assistants for voice and chat in 10+ languages.",
    ...
    features: [
      ...
      { title: "Native Accents", body: "Natural-sounding speech in each language â€” not machine-translated monotone." },
      ...
      { title: "Cultural Context", body: "Beyond translation â€” understands cultural norms, date formats and local conventions." },
    ...
    howItWorks: [
      ...
      { title: "Expand", body: "Add new languages as your customer base grows â€” without rebuilding." },
    ],
    useCases: [
    ...
    faq: [
      ...
      { q: "Can it handle code-switching?", a: "Yes â€” detects when a caller switches languages and adapts in real time." },
    ],
  },
];
